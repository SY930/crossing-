...
import { Breadcrumb, Form, Button, Row, Col, Table, Input } from 'antd';
import { getTable} from '../../../api/from';
                        ...
                        <Col span={6}>
                            < Form.Item label="type" >
                                {getFieldDecorator('type', {
                                    rules: [{ required: true, message: 'Please input the type you got!' }],
                                })(<Input placeholder="" />)}
                            </Form.Item >
                        </Col>
                        <Col span={6}>
                            < Form.Item label="time" >
                                {getFieldDecorator('time', {
                                    rules: [{ required: true, message: 'Please input the time you got!' }],
                                })(<Input placeholder="" />)}
                            </Form.Item >
                        </Col>
                        <Col span={6}>
